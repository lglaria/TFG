...
\begin{figure}[H]
%\centering
  \subfloat[Criptografía asimétrica]{{\includegraphics[width=8cm]{figures/simetrica.png}}}%
  \qquad
  %\caption{Cálculo de $P+Q=R$}
  \subfloat[Criptografía asimétrica]{{\includegraphics[width=8cm]{figures/asimetrica.png}}}%
  %\caption{Cálculo de $2P$ y $-P$}
	\caption{Modelos criptográficos}%
	\label{fig:cripto}%
\end{figure}
