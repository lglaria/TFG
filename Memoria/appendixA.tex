...
\chapter{Implementación del protocolo blockchain (hacer referencia a lo que hecho, sistema de gestión de documentos)}
...
Aquí no solo listar las librerías, sino también explicar en que consisten, como están implementadas y demás, mirando su documentación.
