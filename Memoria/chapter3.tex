...
\begin{figure}[H]
\centering
  \subfloat[Diagrama Árbol Merkle (Fuente \url{https://www.researchgate.net/publication/324385574_Towards_Decentralized_Accountability_and_Self-sovereignty_in_Healthcare_Systems}]{{\includegraphics[width=12cm]{figures/merkle_tree.png}}}%
  \qquad
...
\begin{figure}[H]
%\centering
  \subfloat[Proceso pow (cambiar esta imagen (rehacer en python)]{{\includegraphics[width=12cm]{figures/process_to_modify.png}}}%
  \qquad
...
\begin{figure}[H]
%\centering
  \subfloat[Ejemplo de dispositivo ASIC (Fuente: amazon.com)]{{\includegraphics[width=12cm]{figures/asic.jpg}}}%
  \qquad
  %\caption{Cálculo de $P+Q=R$}
  %\caption{Cálculo de $2P$ y $-P$}
	\label{fig:test}%
